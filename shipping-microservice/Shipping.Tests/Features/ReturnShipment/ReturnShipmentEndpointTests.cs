...
namespace Shipping.Tests.Features.ReturnShipment;

public class ReturnShipmentEndpointTests : IntegrationTestBase
{
    public ReturnShipmentEndpointTests(ShippingWebApplicationFactory webApplicationFactory)
