...
internal sealed class StockReleasedHandler : IEventHandler<StockReleasedEvent>
{
    private readonly ISagaTransitionRunner<OrderSagaStateSnapshot, Event> _runner;

    public StockReleasedHandler(ISagaTransitionRunner<OrderSagaStateSnapshot, Event> runner)
    {
        _runner = runner;
    }

    public Task Handle(StockReleasedEvent @event) =>
