...
namespace Payment.Tests.Features.GetPaymentById;

public class GetPaymentByIdOwnershipTests : IntegrationTestBase
{
    public GetPaymentByIdOwnershipTests(PaymentWebApplicationFactory webApplicationFactory)
