...
{
    [Fact]
    public void Given_default_provider_When_Shipping_host_boots_Then_RabbitMq_messaging_adapters_resolve()
    {
        using var factory = new ShippingMessagingProviderFactory([]);
    ...
    [Fact]
    public void Given_AzureServiceBus_provider_When_Shipping_host_boots_Then_Azure_messaging_adapters_resolve()
    {
        using var factory = new ShippingMessagingProviderFactory(new Dictionary<string, string?>
        {
        ...
        Assert.Equal("shipping-microservice", eventBusOptions.QueueName);
    ...
    private sealed class ShippingMessagingProviderFactory(Dictionary<string, string?> settings)
        ...
        protected override IHost CreateHost(IHostBuilder builder)
        {
            builder.ConfigureHostConfiguration(configurationBuilder =>
            {
                ...
                configurationBuilder.AddInMemoryCollection(new Dictionary<string, string?>
                {
                    ...
                    ["CarrierWebhooks:PollingIntervalSeconds"] = "3600"
                });
            });
