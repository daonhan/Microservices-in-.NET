...
internal sealed class GetPaymentByOrderHandler
{
    ...
    public GetPaymentByOrderHandler(PaymentContext context)
    {
        _context = context;
    }

    public async Task<PaymentResponse?> HandleAsync(ClaimsPrincipal user, Guid orderId)
    {
