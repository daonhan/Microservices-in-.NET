...
> Source PRD: [docs/prd/PRD-ApiGateway-OpenApi-Aggregation.md](../prd/PRD-ApiGateway-OpenApi-Aggregation.md)  [#9](https://github.com/daonhan/Microservices-in-.NET/issues/9)
