...
{
    public InternalOutboxEndpointsTests(InventoryWebApplicationFactory webApplicationFactory)
    ...
    private async Task<Guid> SeedFailedOutboxEventAsync()
    {
        ...
        var evt = new StockReservedEvent(Guid.NewGuid(), Array.Empty<ReservedItem>(), 0m);
