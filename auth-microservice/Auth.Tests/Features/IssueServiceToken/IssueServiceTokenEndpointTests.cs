...
public class IssueServiceTokenEndpointTests : IClassFixture<AuthWebApplicationFactory>, IDisposable
{
    ...
    public void Given_valid_client_credentials_When_issuing_token_Then_returns_ok_and_emits_success_counter()
    {
        ...
        // Act
        var result = IssueServiceTokenEndpoint.Handle(
            BuildHandler(), _metricFactory, "client_credentials", "api-gateway", "s3cret");
    ...
    public void Given_invalid_client_credentials_When_issuing_token_Then_returns_unauthorized_and_emits_failure_counter()
    {
        ...
        // Act
        var result = IssueServiceTokenEndpoint.Handle(
            BuildHandler(), _metricFactory, "client_credentials", "api-gateway", "wrong");
    ...
    {
        var result = IssueServiceTokenEndpoint.Handle(
            BuildHandler(), _metricFactory, "password", "api-gateway", "s3cret");
