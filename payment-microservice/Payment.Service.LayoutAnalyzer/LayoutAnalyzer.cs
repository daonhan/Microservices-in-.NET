...
/// <summary>
/// Roslyn guardrail for the Payment.Service Clean Architecture + Vertical Slices layout.
/// Phase 1 scaffold (issue #227): the diagnostics are declared but no detection logic runs.
/// Detection logic and the silent -> error severity promotion land in Phase 10 (issue #240).
/// </summary>
...
public sealed class LayoutAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        // Phase 1 scaffold (issue #227): rules are intentionally off — no syntax actions registered.
        // Phase 10 (issue #240) wires the banned-namespace / banned-symbol detection.
    }
}
